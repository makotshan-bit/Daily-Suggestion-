...
class DailyApp(ctk.CTk):
    ...
    def setup_ui(self):
        ...
        ctk.CTkLabel(self.m_frame, text="☀️ Morning & Drinks (2 Suggestions)", font=("Cairo", 16, "bold")).pack(pady=5)
        ...
        ctk.CTkLabel(self.e_frame, text="🌙 Evening Activities", font=("Cairo", 16, "bold")).pack(pady=5)
        ...
        # صندوق النتيجة (ثابت في البداية)
        self.result_box = ctk.CTkTextbox(self, height=180, font=("Cairo", 18), corner_radius=15, border_width=2, border_color="#3b8ed0")
        self.result_box.pack(pady=20, padx=20, fill="x")
        self.result_box.insert("0.0", "Welcome! ✨\nClick a button to get suggestions.")
    ...
    def show_double(self, key):
        ...
        # التنسيق النظيف (كل عنصر لوحده من غير القائمة [])
