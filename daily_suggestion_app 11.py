...
class DailyApp(ctk.CTk):
    def __init__(self):
        ...
        self.data = {
            "morning": {
                "healthy_breakfast": ["Oatmeal with honey 🥣", "Greek Yogurt 🥛", "Fruit Salad 🍎", "Avocado Toast 🥑", "Boiled Eggs 🥚", "Chia Pudding 🍮", "Smoothie Bowl 🍓", "Peanut Butter Banana Toast 🍌"],
                "heavy_breakfast": ["Eggs and Toast 🍳", "Pancakes 🥞", "Foul and Falafel 🥙", "Stuffed Omelet 🥚", "Pizza Slice 🍕", "Beef Burger 🍔", "French Toast 🍞", "Waffles with Syrup 🧇"],
                "healthy_drink": ["Fresh Orange juice 🍊", "Cold Milk 🥛", "Green Tea 🍃", "Strawberry Smoothie 🥤", "Lemon & Mint 🍋", "Apple Cider 🍎", "Pomegranate Juice 🥤"],
                "heavy_drink": ["Soda 🥤", "Chocolate Milkshake 🍦", "Iced Chocolate 🧊🍫", "Sweetened Mango Juice 🥭", "Caramel Macchiato ☕", "Cookies & Cream Shake 🍪"],
                "energy_drink": ["Black Coffee ☕", "Strong Tea 🍵", "Double Espresso 🕋", "Matcha Latte 🍵", "Ginseng Tea 🌿", "Red Bull 🥤", "Turkish Coffee ☕"],
                "relax_drink": ["Hot Chocolate 🥛🍫", "Chamomile Tea 🌼", "Warm Milk with Honey 🍯", "Anise 🌿", "Lavender Tea 💜", "Mint Tea 🍃", "Ginger with Lemon 🍋"]
            },
            "evening": {
                "tired": [
    ...
    def setup_ui(self):
        ...
        # --- قسم المساء ---
        self.e_frame = ctk.CTkFrame(self, border_width=1, border_color="#00000")
        ...
        # صندوق النتيجة (تم تغيير text_color إلى black و fg_color إلى white للوضوح)
        self.result_box = ctk.CTkTextbox(self, height=200, 
                                        font=("Segoe UI", 20, "bold"), 
                                        corner_radius=15, 
                                        border_width=2, 
                                        border_color="#00FFFF", 
                                        fg_color="#FFFFFF",   # خلفية بيضاء
                                        text_color="#000000") # خط أسود
    ...
    def show_double(self, key):
        ...
        choices = random.sample(self.data["morning"][key], 3)
