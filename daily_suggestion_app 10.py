...
class DailyApp(ctk.CTk):
    ...
    def setup_ui(self):
        self.label = ctk.CTkLabel(self, text="✨ Your Daily Companion ✨", font=("Cairo", 28, "bold"), text_color="#000000")
        ...
        # صندوق النتيجة (تم تغيير الخط هنا 👇)
        self.result_box = ctk.CTkTextbox(self, height=180, 
                                        font=("Segoe UI", 18), # هنا غيرنا الخط وحجمه
                                        corner_radius=15, 
                                        border_width=2, 
                                        border_color="#00FFFF", 
                                        text_color="#000000")
