...
class DailyApp(ctk.CTk):
        ...
        self.data = {
            "morning": {
                "healthy_breakfast": [
                    ...
                    "Walnuts & Honey 🍯", "Rice Cakes with PB 🥞", "Berry Parfait 🍨"
                ],
                "heavy_breakfast": [
                    ...
                    "Grilled Cheese 🥪", "Turkey Club Sandwich 🥪", "Sausage Rolls 🌭"
                ],
                "healthy_drink": [
                    ...
                    "Beetroot Juice 🥤", "Warm Lemon Water 🍋", "Aloe Vera Juice 🌵"
                ],
                "energy_drink": [
                ...
                "relax_drink": [
                    ...
                    "Rosemary Tea 🌿", "Thyme Tea ☕", "Warm Turmeric Milk 🥛"
                ]
            },
            "evening": {
                "tired": [
                    ...
                    "✨ Listen to a peaceful story 🎧", "✨ Do some deep breathing 💨"
                ],
                "active": [
                    ...
                    "🚀 Clean your workspace 🧼", "🚀 Organize your phone files 📱"
                ]
            },
            "movies": [
    ...
    def setup_ui(self):
        ...
        ctk.CTkButton(btn_grid, text="Healthy Drinks 🥛", command=lambda: self.show_items("healthy_drink"), fg_color="#2ecc71").grid(row=2, column=0, padx=8, pady=8, columnspan=2)
        ...
        # Result Box
        self.result_box = ctk.CTkTextbox(self, height=300, corner_radius=15, border_width=2, border_color="#00FFFF", 
        ...
        self.display_text("Welcome! ✨\nCheck out the new movies and suggestions!")
    ...
    def show_items(self, key, is_morning=True):
        ...
        prefix = "💡 Suggestions for you:" if is_morning else "🌙 Evening Plan (No Numbers):"
        formatted = f"{prefix}\n\n" + "\n".join([f"🔹 {item}" if is_morning else item for item in choices])
        self.display_text(formatted)

    def show_movie(self):
        # يقترح 3 أفلام عشوائية بدل واحد لزيادة الخيارات
